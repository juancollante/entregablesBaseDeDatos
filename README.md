...
Resumen ejecutivo
    ...
    Archivos relevantes: Migraciones y configuración:
        src/main/resources/db/migration/V1__notificaciones_schema.sql
        src/main/resources/db/migration/V2__seed_plantillas.sql
        src/main/resources/db/migration/V3__preferencias_usuario_unique.sql
        src/main/resources/db/migration/V4__seed_plantilla_auth_login.sql
        src/main/resources/application.properties

Flujo de migraciones

    Orden de ejecución (Flyway):
        V1__notificaciones_schema.sql — crea tablas e índices.
        V2__seed_plantillas.sql — inserta plantillas iniciales.
        V3__preferencias_usuario_unique.sql — índice único condicional para preferencias.
        V4__seed_plantilla_auth_login.sql — inserta plantilla adicional (AUTH_LOGIN).
...
Ver: V1__notificaciones_schema.sql y V2__seed_plantillas.sql.
notificaciones
...
Ver: V1__notificaciones_schema.sql.
...
Ver: V1__notificaciones_schema.sql y V3__preferencias_usuario_unique.sql.
consumo_eventos
...
Ver: V2__seed_plantillas.sql y V4__seed_plantilla_auth_login.sql.
